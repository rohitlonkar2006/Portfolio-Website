        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>BUILD AI SYSTEMS</h3>
              <h4>Agentic AI Development</h4>
              <p>
                I design AI agents that connect language models with tools,
                APIs, memory, and business workflows.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I turn raw data into reliable insights through cleaning,
                exploration, statistics, visualization, and dashboards.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
